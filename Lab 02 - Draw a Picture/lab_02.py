...
# CAR? - SOME VEHICLE
#arcade.draw_lrtb_rectangle_filled(50, 300, 170, 50, arcade.color.GRAY_BLUE)
##arcade.draw_circle_filled(100, 50, 30, arcade.color.BATTLESHIP_GREY)
#arcade.draw_circle_filled(240, 50, 30, arcade.color.BATTLESHIP_GREY)
#arcade.draw_lrtb_rectangle_filled(100, 150, 150, 100, arcade.color.BLACK)
